...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (Core.isSubClassOf("MyFirstModule.CarColorImage", mendixObject.getType()))
			return myfirstmodule.proxies.CarColorImage.initialize(context, mendixObject);

		if (Core.isSubClassOf("MyFirstModule.CarImage", mendixObject.getType()))
			return myfirstmodule.proxies.CarImage.initialize(context, mendixObject);

		if (Core.isSubClassOf("MyFirstModule.CoachworkImage", mendixObject.getType()))
